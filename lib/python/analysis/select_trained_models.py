...
for C in [2, 4]:
    for D_cnn in [1, 2, 3, 4]:
        R_performance_array_natural = []
        R_performance_array_inverted = []
        R_performance_array_phase_random = []
        R_performance_array_gaussian = []
        ...
        for R in tqdm(range(500)):
            ...
            if os.path.exists(model_path + f'y_pred_all.pth'):
                ...
                if explained_variance >= rsquare_thres:
                    R_performance_array_natural.append([R+1, explained_variance, direction_accuracy])
            ...
            if os.path.exists(model_path + f'y_pred_all.pth'):
                ...
                if explained_variance >= rsquare_thres:
                    R_performance_array_inverted.append([R+1, explained_variance, direction_accuracy])
            ...
            if os.path.exists(model_path + f'y_pred_all.pth'):
                ...
                if explained_variance >= rsquare_thres:
                    R_performance_array_gaussian.append([R+1, explained_variance, direction_accuracy])


        np.save(f'../results/variables_for_paper/R_performance_array_natural_C{C}_D{D_cnn}_thres{rsquare_thres}', R_performance_array_natural)
        np.save(f'../results/variables_for_paper/R_performance_array_inverted_C{C}_D{D_cnn}_thres{rsquare_thres}', R_performance_array_inverted)
        np.save(f'../results/variables_for_paper/R_performance_array_phase_random_C{C}_D{D_cnn}_thres{rsquare_thres}', R_performance_array_phase_random)
        np.save(f'../results/variables_for_paper/R_performance_array_gaussian_C{C}_D{D_cnn}_thres{rsquare_thres}', R_performance_array_gaussian)
