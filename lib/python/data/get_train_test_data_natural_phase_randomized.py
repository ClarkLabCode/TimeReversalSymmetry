...
def main(_):
    ...
    folder_nat = data_folder + 'panoramic/data_natural_only_filtered_phase_randomized/'
    ...
    for nt in tqdm(range(int(N_train/2))):
        ...
        X_train = X_train / X_train.flatten().std() * contrast_scale
    ...
    for nt in tqdm(range(int(N_test/2))):
        ...
        X_test = X_test / X_test.flatten().std() * contrast_scale
