function MovingEdgesAnalysisPipeline(symmetries, stim_number, number_for_display)

savepath = 'D:\Figures\fig3\supplementary_moving_edges_processing\';
...
figLeg={['$R(S_{' num2str(number_for_display) '})$'], ['$R(_\Theta S_{' num2str(number_for_display) '})$'], ['$R(_\Gamma S_{' num2str(number_for_display) '})$'], ['$R(_{\Gamma\Theta} S_{' num2str(number_for_display) '})$']};

%%
%TFlipFigLeg = {['$R(S_{' num2str(number_for_display) '}) + R(_\Theta S_{' num2str(number_for_display) '})$'], ['$R(_\Gamma S_{' num2str(number_for_display) '}) + R(_{\Gamma\Theta} S_{' num2str(number_for_display) '})$']};
%CFlipFigLeg = {['$R(S_{' num2str(number_for_display) '}) - R(_\Gamma S_{' num2str(number_for_display) '})$'], ['$R(_\Theta S_{' num2str(number_for_display) '}) - R(_{\Gamma\Theta} S_{' num2str(number_for_display) '})$']};
%CTFlipFigLeg = {['$R(S_{' num2str(number_for_display) '}) + R(_{\Gamma\Theta} S_{' num2str(number_for_display) '})$'], ['$R(_\Gamma S_{' num2str(number_for_display) '}) + R(_\Theta S_{' num2str(number_for_display) '})$']};
...
ylabel(ax{1}, ['turning (' char(186) '/s)']);
...
ax{5} = subplot(4, 4, 5);
hold on
title(TFlipFigLeg{1}, 'Interpreter', 'latex')
PlotXvsY(timeXiso, allFliesTCombined(:, 1), 'error', stderrorsTCombined(:, 1), 'plotColor', color(2, :))
xlim([-1 4])
yline(0, '--', 'Color', 'black', 'LineWidth', 1)
%xline(0, '--', 'Color', [0.5 0.5 0.5]) % vertical 0 line
%xline(3, '--', 'Color', [0.5 0.5 0.5]) %vertical 3 line
...
ax{6} = subplot(4, 4, 6);
hold on
title(TFlipFigLeg{2}, 'Interpreter', 'latex')
PlotXvsY(timeXiso, allFliesTCombined(:, 2), 'error', stderrorsTCombined(:, 2), 'plotColor', color(2, :))
xlim([-1 4])
yline(0, '--', 'Color', 'black', 'LineWidth', 1)
%xline(0, '--', 'Color', [0.5 0.5 0.5]) % vertical 0 line
%xline(3, '--', 'Color', [0.5 0.5 0.5]) %vertical 3 line
...
plot(jitter + 1, indFlyTCombinedMeanTurning(:, 1), 'ko', 'Color', [0.7 0.7 0.7], 'MarkerFaceColor', [0.7 0.7 0.7], 'MarkerEdgeColor', [0.7 0.7 0.7]);
plot(jitter + 2, indFlyTCombinedMeanTurning(:, 2), 'ko', 'Color', [0.7 0.7 0.7], 'MarkerFaceColor', [0.7 0.7 0.7], 'MarkerEdgeColor', [0.7 0.7 0.7]);
...
ax{8} = subplot(4, 4, 9);
hold on
title(CFlipFigLeg{1}, 'Interpreter', 'latex')
PlotXvsY(timeXiso, allFliesCCombined(:, 1), 'error', stderrorsCCombined(:, 1), 'plotColor', color(3, :))
xlim([-1 4])
yline(0, '--', 'Color', 'black', 'LineWidth', 1)
%xline(0, '--', 'Color', [0.5 0.5 0.5]) % vertical 0 line
%xline(3, '--', 'Color', [0.5 0.5 0.5]) %vertical 3 line
...
ax{9} = subplot(4, 4, 10);
hold on
title(CFlipFigLeg{2}, 'Interpreter', 'latex')
PlotXvsY(timeXiso, allFliesCCombined(:, 2), 'error', stderrorsCCombined(:, 2), 'plotColor', color(3, :))
xlim([-1 4])
yline(0, '--', 'Color', 'black', 'LineWidth', 1)
%xline(0, '--', 'Color', [0.5 0.5 0.5]) % vertical 0 line
%xline(3, '--', 'Color', [0.5 0.5 0.5]) %vertical 3 line
...
plot(jitter + 1, indFlyCCombinedMeanTurning(:, 1), 'ko', 'Color', [0.7 0.7 0.7], 'MarkerFaceColor', [0.7 0.7 0.7], 'MarkerEdgeColor', [0.7 0.7 0.7]);
plot(jitter + 2, indFlyCCombinedMeanTurning(:, 2), 'ko', 'Color', [0.7 0.7 0.7], 'MarkerFaceColor', [0.7 0.7 0.7], 'MarkerEdgeColor', [0.7 0.7 0.7]);
...
%ct flips
ax{11} = subplot(4, 4, 13);
hold on
title(CTFlipFigLeg{1}, 'Interpreter', 'latex')
PlotXvsY(timeXiso, allFliesCTCombined(:, 1), 'error', stderrorsCTCombined(:, 1), 'plotColor', color(4, :))
xlim([-1 4])
yline(0, '--', 'Color', 'black', 'LineWidth', 1)
%xline(0, '--', 'Color', [0.5 0.5 0.5]) % vertical 0 line
%xline(3, '--', 'Color', [0.5 0.5 0.5]) %vertical 3 line
...
ax{12} = subplot(4, 4, 14);
hold on
title(CTFlipFigLeg{2}, 'Interpreter', 'latex')
PlotXvsY(timeXiso, allFliesCTCombined(:, 2), 'error', stderrorsCTCombined(:, 2), 'plotColor', color(4, :))
xlim([-1 4])
yline(0, '--', 'Color', 'black', 'LineWidth', 1)
%xline(0, '--', 'Color', [0.5 0.5 0.5]) % vertical 0 line
%xline(3, '--', 'Color', [0.5 0.5 0.5]) %vertical 3 line
...
plot(jitter + 1, indFlyCTCombinedMeanTurning(:, 1), 'ko', 'Color', [0.7 0.7 0.7], 'MarkerFaceColor', [0.7 0.7 0.7], 'MarkerEdgeColor', [0.7 0.7 0.7]);
plot(jitter + 2, indFlyCTCombinedMeanTurning(:, 2), 'ko', 'Color', [0.7 0.7 0.7], 'MarkerFaceColor', [0.7 0.7 0.7], 'MarkerEdgeColor', [0.7 0.7 0.7]);
...
set([ax{2} ax{3} ax{4} ax{6} ax{9} ax{12}],'YTickLabel',[]);

linkaxes([ax{1} ax{2} ax{3} ax{4}], 'y');

linkaxes([ax{5} ax{6}], 'y');

linkaxes([ax{8} ax{9}], 'y');
linkaxes([ax{11} ax{12}], 'y');
